...
## 왜 사용해야 할까?
React의 데이터 흐름은 **단방향**으로 이루어져있다.
**부모 컴포넌트**가 가진 데이터를 **전역**에서 사용할려면 **자식 컴포넌트**에게 값을 **전달**해줘야하는데,
너무 많은 컴포넌트가 존재한다면 **props drilling**이 **발생**하게 된다.

![700x400](Pasted%20image%2020260113145741.png)
## 언제 사용할까?
